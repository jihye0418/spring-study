...
public class Main {
	...
	//2.xml파일을 메모리에 올려줄 수 있는 클래스를 통해서 객체를 생성->p49
	   ...
	   PerformanceMoniter moniter=context.getBean("performanceMoniter",
			                                                         PerformanceMoniter.class);
	   PerformanceMoniter moniter2=context.getBean("performanceMoniter",
                                                                     PerformanceMoniter.class);
	   PerformanceMoniter moniter3=context.getBean("performanceMoniter",
                                                                      PerformanceMoniter.class);
